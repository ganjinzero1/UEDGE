...
cfpuffmatrix(1:2,0:nx+1,ngspmx)             _real /0./ +maybeinput # puffing matrix if isvacuummodel = 1,2,3
...
fngyteleout(1:2,0:nx+1,ngspmx)              _real      # flux of tele-transport neutral going out of the outer boundary,
fngytelein(1:2,0:nx+1,ngspmx)               _real      # flux of tele-transport neutral coming back into the outer boundary,
	                                           # = fngyteleout*cftelematrix
fngytelemaxw(1:2,0:nx+1,ngspmx)             _real      # flux of tele-transport neutral going out of the outer boundary, assuming half-Maxw
                                                       # positive sign means that flux is pointing out of the boundary for both i,o boundaries.
fngytelediff(1:2,0:nx+1,ngspmx)             _real      # flux of tele-transport neutral going out of the outer boundary, assuming CX diffusion
                                                   ...
                                                   # positive sign means that flux is pointing out of the boundary for both i,o boundaries.
fngytelediff1(1:2,0:nx+1,ngspmx)             _real     # first component of fngytelediff
fngytelediff2(1:2,0:nx+1,ngspmx)             _real     # second component of fngytelediff
fngytelediff3(1:2,0:nx+1,ngspmx)             _real     # third component of fngytelediff
fngytelediff30(1:2,0:nx+1,ngspmx)             _real     # third component of fngytelediff before applying limiter
...
Kn(1:2,0:nx+1,ngspmx)           _real     # Knusen number at the outer boundary, = lmfpn/lteleout, where lmfpn = sqrt(Tg/mg)/nucx
...
fmgyteleout(1:2,0:nx+1,ngsp)   _real      # mom. flux of tele-transport neutral going out of the outer boundary,
fmgytelein(1:2,0:nx+1,ngsp)    _real      # mom. flux of tele-transport neutral coming back into the outer boundary,
                                      # = 0. for current model, assuming wall absorb all the mom. and energy
fmgytelemaxw(1:2,0:nx+1,ngsp)  _real      # mom. flux of tele-transport neutral going out of the outer boundary, assuming half-Maxw
                                      # fegytelemaxw = fngytelemaxw*mu_p
fmgytelediff(1:2,0:nx+1,ngsp)  _real      # mom. flux of tele-transport neutral going out of the outer boundary, assuming CX diffusion
...
fmgytelediff1(1:2,0:nx+1,ngsp)  _real     # first component of fmgytelediff
fmgytelediff2(1:2,0:nx+1,ngsp)  _real     # second component of fmgytelediff
fmgytelediff3(1:2,0:nx+1,ngsp)  _real     # third component of fmgytelediff
fegyteleout(1:2,0:nx+1,ngsp)   _real      # eng. flux of tele-transport neutral going out of the outer boundary,
fegytelein(1:2,0:nx+1,ngsp)    _real      # eng. flux of tele-transport neutral coming back into the outer boundary,
                                      # = 0. for current model, assuming wall absorb all the mom. and energy
fegytelemaxw(1:2,0:nx+1,ngsp)  _real      # eng. flux of tele-transport neutral going out of the outer boundary, assuming half-Maxw
                                      # fegytelemaxw = fngytelemaxw*(0.5mu_p^2 + 2T), omit 0.5mu_p^2 for internal
fegytelediff(1:2,0:nx+1,ngsp)  _real      # eng. flux of tele-transport neutral going out of the outer boundary, assuming CX diffusion
...
fegytelediff1(1:2,0:nx+1,ngsp)  _real     # first component of fegytelediff
fegytelediff2(1:2,0:nx+1,ngsp)  _real     # second component of fegytelediff
fegytelediff3(1:2,0:nx+1,ngsp)  _real     # third component of fegytelediff
